...
1. **Information over Prescription** - Provide AI agents with context and knowledge, not rigid rules that may become outdated
2. **Security by Default** - Configure agents to operate within security controls, never suggesting bypasses or workarounds
